...
The action space consist in a $n_{\text{stocks}}$ dimensional box $[-1, 1]^{n_{\text{stocks}}}$. An action in this continuous action space is then rescaled by a fixed factor and cast to an integer to obtain the number of shares to buy or sell for each asset.
...
SAC v3 (Automatic Temperature): https://arxiv.org/abs/1812.05905
